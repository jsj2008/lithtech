...
class CServerSaveLoadMgr : public CSaveLoadMgr, public IPlayerTrackerReceiver
{
	public : // Methods...
		...
		bool			SaveGameSlot( int nSlot, const char *pszSaveName );
		...
		bool			AutoSave( int nMission, int nLevel );
	...
	private :
		...
		CString			m_sSaveDataNewLevel;

		// Save game info.  Used with QuickSave and SaveGameSlot.
		CString			m_sSaveGameDir;
		CString			m_sSaveGameFile;
		CString			m_sSaveGameKey;
		CString			m_sSaveGameTitle;
