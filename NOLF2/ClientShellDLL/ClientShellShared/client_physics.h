...
// vector.  Returns LTFALSE if the object shouldn't move.

LTBOOL UpdateMovingObject(PhysicsState *pState, MovingObject *pObject, LTVector &vNewPos);
...
LTBOOL BounceMovingObject(PhysicsState *pState, MovingObject *pObject,
    LTVector &vNewPos, ClientIntersectInfo* pInfo, uint32 dwQueryFlags,
	bool bIgnoreMovingObjects, LTBOOL & bBounceOnGround);
