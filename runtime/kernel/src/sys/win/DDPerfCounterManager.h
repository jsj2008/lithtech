// Win32_PerfCounterManager.h
//	Win32 Implementation of the PerfCounterManager
// Note: This needs to implemented on all platforms (getting the CPU Perf Counter)

#ifndef __DDPERFCOUNTERMANAGER_H__
#define __DDPERFCOUNTERMANAGER_H__
...
class CWin32PerfCounterMan : public CDIPerfCounterMan {
public:
	CWin32PerfCounterMan()									{ m_iFreq.QuadPart = 0; }
private:
...
extern CWin32PerfCounterMan g_PerfCounterManager;			// There should only be one of these guys around - use the access functions to get at him...
