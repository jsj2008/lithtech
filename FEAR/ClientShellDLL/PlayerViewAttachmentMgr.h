...
class CPlayerViewAttachmentMgr
{
	...
	protected: // Methods...
		...
		void		CreatePVAttachment( const char *pszPVAttachmentPosition, HRECORD hPVAttachmentRecord );
	...
	protected: // Members...
		...
		typedef std::vector<CPlayerViewAttachment, LTAllocator<CPlayerViewAttachment, LT_MEM_TYPE_CLIENTSHELL> > PVAttachmentList;
	
		PVAttachmentList	m_lstPVAttachments;		// List of all current player-view attachments

		LTObjRef			m_hObject;				// Object that the attachments are attached to
};
