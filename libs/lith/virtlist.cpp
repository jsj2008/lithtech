...
void CVirtBaseList::InsertFirst(CVirtBaseListItem* pItem) {
  ASSERT(pItem != NULL);
...
void CVirtBaseList::InsertLast(CVirtBaseListItem* pItem) {
  ASSERT(pItem != NULL);
  pItem->m_pNext = NULL;
...
void CVirtBaseList::Delete(CVirtBaseListItem* pItem) {
  ASSERT(pItem != NULL);
