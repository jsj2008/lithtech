...
//
//   PURPOSE : Implements class CBouncyChunkFX
//
...
// ----------------------------------------------------------------------- //
//
//  ROUTINE:	CBouncyChunkProps::CBouncyChunkProps
//
//  PURPOSE:	Constructor
//
// ----------------------------------------------------------------------- //
...
// ----------------------------------------------------------------------- //
//
//  ROUTINE:	CBouncyChunkProps::ReadProps
//
//  PURPOSE:	Read in the proporty values that were set in FxED
//
// ----------------------------------------------------------------------- //

bool CBouncyChunkProps::ParseProperties(FX_PROP* pProps, uint32 nNumProps)
{
...
//------------------------------------------------------------------
//
//   FUNCTION : CBouncyChunkFX()
//
//   PURPOSE  : Standard constuctor
//
//------------------------------------------------------------------

CBouncyChunkFX::CBouncyChunkFX()
{
	m_hBouncyChunk = NULL;
	m_hImpactSound = NULL;
}
...
//   FUNCTION : Init()
//
//   PURPOSE  : Initialises class CBouncyChunkFX
//
//------------------------------------------------------------------
...
//   FUNCTION : Term()
//
//   PURPOSE  : Terminates class CBouncyChunkFX
//
//------------------------------------------------------------------

void CBouncyChunkFX::Term()
{
...
//   FUNCTION : Update()
//
//   PURPOSE  : Updates class CBouncyChunkFX
//
//------------------------------------------------------------------
