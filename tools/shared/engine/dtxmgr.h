...
#define __DTXMGR_H__
	...
	LTRESULT dtx_Create(ILTStream *pStream, TextureData **ppOut, LTBOOL bLoadSections, LTBOOL bSkipImageData=FALSE);
	...
	LTRESULT dtx_Save(TextureData *pData, ILTStream *pStream);
