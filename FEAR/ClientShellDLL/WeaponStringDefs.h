...
#define	  WS_ERROR_STRING	L"Error"

#include "iclientshell.h"

inline wchar_t* GetWeaponString(uint8 nWeaponId)
{
	...
	return pWeapon->wszShortName;
}

inline wchar_t* GetAmmoString(int nAmmoId)
{
    if (!g_pLTClient || !g_pWeaponMgr) return WS_ERROR_STRING;
